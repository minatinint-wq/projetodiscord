...
export default function ProfileOverlay({effect,animated=true}){
 if(!effect||effect==="none")return null;
 if(["lunar-orbit","gothic-bloom","holo-circuit","sakura-shrine","steel-wolf","infernal-dragon"].includes(effect))return <PremiumProfileOverlay effect={effect} animated={animated}/>;
