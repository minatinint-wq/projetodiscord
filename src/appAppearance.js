...
export function appAppearance(preferences = {}, fallbackTheme = "dark") {
  ...
  return {
    ...
    style: {
      ...
      "--interactive-hover": mix(surface, accent, light ? 0.1 : 0.14),
      "--interactive-selected": mix(surface, accent, light ? 0.2 : 0.34),
      "--interactive-border": mix(surface, accent, light ? 0.38 : 0.56),
