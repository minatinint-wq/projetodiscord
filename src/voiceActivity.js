...
export function updateVoiceActivity(state={},samples,now=performance.now()){
 let energy=0
 ...
 const startThreshold=Math.max(.026,noiseFloor*2.45)
 const stopThreshold=Math.max(.016,noiseFloor*1.55)
