...
export default function ProfileCard({user,Avatar,ProfileEffectLayer,renderBadges,presence="offline"}){
 ...
 return <section className="identity-card" style={profilePresentation(user)} data-effect={user.profileEffect||"none"} data-profile-frame={user.profileFrame||"none"}>
  ...
  <div className="identity-card-body">
   ...
   <h2><StyledName user={user} roleAware={false}/></h2><p className="identity-handle">@{user.username}</p>
