...
Object.assign(process.env,{HOST:"127.0.0.1",PORT:"34170",DATA_FILE:path.join(temp,"database.json"),DATABASE_URL:"",SEED_DEMO_USER:"true",REGISTER_MAX_PER_HOUR:"100",MASTER_ADMIN_EMAIL:"browser-admin@sesh.test",MASTER_ADMIN_EMAILS:"",MASTER_ADMIN_PASSWORD:"browser-admin-test-only",CREATOR_EMAIL:"",CREATOR_EMAILS:"",RESEND_API_KEY:""});
